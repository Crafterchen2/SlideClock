...
try {
    ...
    console.log("settings.js -> This doesn't seem to be the Wallpaper Engine.");
}
...
function applySettings() {
    ...
    e.style.backgroundImage = buildRgbRgbLinGrad(settings.clock.background.pColor, settings.clock.background.sColor);
    ...
    e.style.backgroundImage = buildRgbaRgbaLinGrad(settings.player.fallbackBackground.pColor, settings.player.fallbackBackground.sColor);
    e.style.boxShadow = shadow;
